...
class Order(Base):
    ...
    products = Column(JSONB, nullable=False)  # List of product IDs & quantities
...
class Product(Base):
    ...
    features = Column(JSONB, nullable=True)  # Key specifications
...
class FAQ(Base):
    ...
    # embedding = Column(Vector(768))  # FAISS vector for similarity search
